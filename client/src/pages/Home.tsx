            ...
            <div className="flex flex-col justify-center px-6 py-10 sm:px-11 lg:px-14">
              <div className="mx-auto w-full max-w-xl">
                ...
                <form onSubmit={submit} className="space-y-4">
                  ...
                  <p className="text-xs leading-5 text-[#8d93a0]">ShortWave links are detected but gated by prior viewing time. DramaFren watch pages are single embeds, not episode lists.</p>
